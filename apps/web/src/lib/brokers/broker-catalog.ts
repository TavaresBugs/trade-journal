...
export const PLATFORM_METADATA: Record<string, { name: string; icon?: string; gateway?: string }> =
  {
    ...
    topstepx: { name: "TopstepX", icon: "tradovate.svg", gateway: "ProjectX" },
    ...
    dastrader: { name: "DAS Trader Pro" },
    tradervue: { name: "Tradervue" },
    tradezella: { name: "TradeZella" },
  };
